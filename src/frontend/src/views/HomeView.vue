<template>
  <div class="home-view">
    ...
    <SplitLayoutSection
      ...
      image-alt="描述圖片 1"
      title="步驟一：選擇風格圖片"
      description="您需要選擇一張圖片作為最終成品的「大圖」或「輪廓」。"
    ...
    <SplitLayoutSection
      ...
      title="步驟二：選擇素材圖片"
      description="
您有兩種方式可以提供素材圖片：使用自己的照片（例如：生活照、旅行照、家庭合照等）來創作，或是用我們提供的素材庫。"
      class="animate-on-scroll animate-fade-in-up"
    />
    <SplitLayoutSection
      :image-url="img_mos_cat"
      image-alt="描述圖片 3"
      title="步驟三: 點擊 開始生成拼貼畫"
      description="
點擊後，BlurNest 會分析您的風格圖片，並從您的素材庫中挑選顏色和形狀最匹配的小圖片，將它們拼貼成最終的馬賽克圖像。
這個過程可能需要一些時間，具體取決於您上傳的圖片數量和大小。請耐心等候。預覽與下載生成完成後，您將可以看到最終的馬賽克拼貼照片。"
      class="animate-on-scroll animate-fade-in-up"
    />
    <!-- 反轉佈局：右圖左文 -->
    <!-- <SplitLayoutSection
...
import img_cat from '../assets/cat.jpeg'
import img_album from '../assets/album.jpg'
import img_mos_cat from '../assets/mosCat.png'
